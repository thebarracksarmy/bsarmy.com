...
<footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
	...
	<div class="col mb-3">
		...
		<ul class="nav flex-column">
			<li class="nav-item mb-2"><a href="https://bsarmy.com/" class="nav-link p-0 text-body-secondary">Home</a></li>
			<li class="nav-item mb-2"><a href="https://bsarmy.com/login/" class="nav-link p-0 text-body-secondary">Login</a></li>
			<li class="nav-item mb-2"><a href="https://bsarmy.com/register/" class="nav-link p-0 text-body-secondary">Signup</a></li>
			<li class="nav-item mb-2"><a href="https://bsarmy.com/contact/" class="nav-link p-0 text-body-secondary disabled" disabled>Contact</a></li>
			<li class="nav-item mb-2"><a href="https://bsarmy.com/about/" class="nav-link p-0 text-body-secondary disabled" disabled>About</a></li>
		</ul>
	</div>
	...
	<div class="col mb-3">
		...
		<ul class="nav flex-column">
			...
			<li class="nav-item mb-2"><a href="https://bsarmy.com/docs/terms_conditions/" class="nav-link p-0 text-body-secondary">Terms & Conditions</a></li>
